...
var wpAjaxUrl =
  "https://www.premiersupportservices.co.uk/wp-admin/admin-ajax.php";
var flBuilderUrl =
  "https://www.premiersupportservices.co.uk/wp-content/plugins/bb-plugin/";
  ...
  FLBuilderLayout = {
    ...
    _string_to_slug: function (str) {
      ...
      if ("undefined" == typeof window._fl_string_to_slug_regex) {
        ...
        regex = new RegExp(
          "[^" + window._fl_string_to_slug_regex + "'\":() !.,-_|\\p{Letter}]",
          "ug"
        );
      }
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f78852a99ab5 .fl-photo-img")
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f78852a99aaf .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7884eb2c9e1 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7881c8f40f4 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f78842282d33 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7884eb2c9db .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318923 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318926 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318924 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318928 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318922 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318927 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318925 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
jQuery(function ($) {
  $(function () {
    $(".fl-node-5f7ca73318929 .fl-photo-img")
      .on("mouseenter", function (e) {
        $(this).data("title", $(this).attr("title")).removeAttr("title");
      })
      .on("mouseleave", function (e) {
...
(function ($) {
  ...
  PPImageCarousel.prototype = {
    ...
    swipers: {},
    _init: function () {
      this.elements = { mainSwiper: this.nodeClass + " .pp-image-carousel" };
      this.elements.swiperSlide = $(this.elements.mainSwiper).find(
      ...
      if (
        this.settings.pause_on_interaction &&
        this.settings.autoplay_speed !== false
      ) {
        var self = this;
        $(this.swipers.main.el)
    ...
    _getSwiperOptions: function () {
      ...
      var options = {
        ...
        loop:
          "undefined" !== typeof this.settings.loop ? this.settings.loop : true,
        speed: this.settings.speed,
        breakpoints: {},
        on: { init: addAriaLabels, slideChange: addAriaLabels },
      };
      if (
        window.innerWidth > large_breakpoint &&
        this._getSlidesCount() <= this._getSlidesPerView()
      ) {
      ...
      if (
        ...
        this._getSlidesCount() <= this._getSlidesPerViewLarge()
      ) {
        options.pagination = false;
      }
      if (
        ...
        this._getSlidesCount() <= this._getSlidesPerViewTablet()
      ) {
        options.pagination = false;
      }
      if (
        window.innerWidth >= responsive_breakpoint &&
        this._getSlidesCount() <= this._getSlidesPerViewMobile()
      ) {
        options.pagination = false;
      }
      if (!this.settings.isBuilderActive) {
        options.preloadImages = false;
        options.lazy = { enabled: true, checkInView: true };
      }
      if (this._isSlideshow()) {
      ...
      if (
        ...
        options.autoplay = {
          ...
          stopOnLastSlide:
            "undefined" !== typeof this.settings.stopOnLastSlide
              ? this.settings.stopOnLastSlide
              : false,
        };
      }
      ...
      if (
        "carousel" === this.settings.type &&
        $(this.nodeClass).hasClass("centered-slides")
      ) {
      ...
      if ("coverflow" === this.settings.type) {
        ...
        if (
          window.innerWidth <= medium_breakpoint &&
          window.innerWidth > responsive_breakpoint &&
          this._getSlidesPerViewTablet() <= 2
        ) {
          options.centeredSlides = false;
        }
        if (
          window.innerWidth >= responsive_breakpoint &&
          this._getSlidesPerViewMobile() <= 2
        ) {
          options.centeredSlides = false;
        }
      }
      ...
      if (!this.settings.isBuilderActive) {
        ...
        thumbsSliderOptions.lazy = { enabled: true, checkInView: true };
      }
      return { main: options, thumbs: thumbsSliderOptions };
    },
    ...
    _updateSpaceBetween: function (swiper, property) {
      ...
      if (deviceMatch) {
        ...
        swiper.params.breakpoints[breakpoints[deviceMatch[1]]].spaceBetween =
          newSpaceBw;
      } else {
...
var carousel_5fa51a5aab337 = "";
(function ($) {
  var settings = {
    id: "5fa51a5aab337",
    type: "carousel",
    initialSlide: 0,
    slidesPerView: { desktop: 6, large: 0, tablet: 4, mobile: 0 },
    slidesToScroll: { desktop: 1, large: 1, tablet: 1, mobile: 1 },
    slideshow_slidesPerView: { desktop: 5, large: 0, tablet: 0, mobile: 0 },
    spaceBetween: { desktop: "55", large: "", tablet: "0", mobile: "" },
    ...
    effect: "slide",
    speed: 1000,
    breakpoint: { large: 1200, medium: 992, responsive: 768 },
    navText: { prev: "Previous slide", next: "Next slide" },
  };
  settings.loop = true;
  carousel_5fa51a5aab337 = new PPImageCarousel(settings);
  function updateCarousel() {
    setTimeout(function () {
      if ("number" !== typeof carousel_5fa51a5aab337.swipers.main.length) {
        carousel_5fa51a5aab337.swipers.main.update();
        if ("object" === typeof carousel_5fa51a5aab337.swipers.thumbs) {
          carousel_5fa51a5aab337.swipers.thumbs.update();
        }
      } else {
        carousel_5fa51a5aab337.swipers.main.forEach(function (item) {
  ...
  $(document).on("pp_modal_box_rendered", function (e, selector) {
    if (selector.find(".fl-node-5fa51a5aab337").length > 0) {
      updateCarousel();
    }
  });
  $(document).on("fl-builder.pp-accordion-toggle-complete", function (e) {
    if ($(e.target).find(".fl-node-5fa51a5aab337").length > 0) {
      updateCarousel();
    }
  });
  ...
  $(".fl-tabs")
    ...
    .on("click", function () {
      ...
      var panel = $(this)
        .parents(".fl-tabs")
        .find('.fl-tabs-panel-content[data-index="' + index + '"]');
      if (panel.find(".fl-node-5fa51a5aab337").length > 0) {
        updateCarousel();
      }
    });
  var state = 0;
  $(document).on("pp_expandable_row_toggle", function (e, selector) {
    if (
      selector.is(".pp-er-open") &&
      state === 0 &&
      selector.parent().find(".fl-node-5fa51a5aab337").length > 0
    ) {
      updateCarousel();
      state = 1;
    }
...
(function ($) {
  ...
  settings.loop = true;
  carousel_5fa51a5aab338 = new PPImageCarousel(settings);
  function updateCarousel() {
    setTimeout(function () {
      if ("number" !== typeof carousel_5fa51a5aab338.swipers.main.length) {
        carousel_5fa51a5aab338.swipers.main.update();
        if ("object" === typeof carousel_5fa51a5aab338.swipers.thumbs) {
          carousel_5fa51a5aab338.swipers.thumbs.update();
        }
      } else {
        carousel_5fa51a5aab338.swipers.main.forEach(function (item) {
          if ("undefined" !== typeof item) {
            item.update();
          }
        });
  ...
  $(document).on("pp_modal_box_rendered", function (e, selector) {
    if (selector.find(".fl-node-5fa51a5aab338").length > 0) {
      updateCarousel();
    }
  });
  $(document).on("fl-builder.pp-accordion-toggle-complete", function (e) {
    if ($(e.target).find(".fl-node-5fa51a5aab338").length > 0) {
      updateCarousel();
    }
  });
  $(document).on("pp-tabs-switched", function (e, selector) {
  ...
  $(".fl-tabs")
    ...
    .on("click", function () {
      ...
      var panel = $(this)
        .parents(".fl-tabs")
        .find('.fl-tabs-panel-content[data-index="' + index + '"]');
      if (panel.find(".fl-node-5fa51a5aab338").length > 0) {
        updateCarousel();
      }
    });
  var state = 0;
  $(document).on("pp_expandable_row_toggle", function (e, selector) {
    if (
      selector.is(".pp-er-open") &&
      state === 0 &&
      selector.parent().find(".fl-node-5fa51a5aab338").length > 0
    ) {
      updateCarousel();
      state = 1;
    }
...
(function ($) {
  $(function () {
    $(".fl-node-5fa51a699b064 .fl-mosaicflow-content")
  ...
  jQuery(document).ready(function () {
    setTimeout(function () {
      jQuery(".fl-node-5fa51a699b064 .fl-mosaicflow-content").trigger("resize");
    }, 50);
  });
})(jQuery);
(function ($) {
  function equalheight() {
    ...
    var maxHeight = 0;
    $(".fl-node-vromtekand0u .pp-logos-wrapper .pp-logo").each(function (
      index
    ) {
    ...
    $(".fl-node-vromtekand0u .pp-logos-wrapper .pp-logo").css(
      "height",
      maxHeight + "px"
    );
    return maxHeight;
  }
  $(".fl-node-vromtekand0u .pp-logos-wrapper").imagesLoaded(function () {});
})(jQuery);
